...
### 1. ユーザーのクリック操作を起点に処理を実行できるようにする
...
### 3. フォームのデフォルト動作を制御してJavaScriptで処理できるようにする
...
**次のステップ:** [07 非同期処理](../07-async/README.md) では、通信やタイマーなど時間のかかる処理を扱うための非同期処理の仕組みを学びます。
